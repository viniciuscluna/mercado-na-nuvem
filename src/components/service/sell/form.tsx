        ...
        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
            <div className="grid gap-6 mb-6 md:grid-cols-4 w-full">
                {Array.isArray(produtos) && produtos &&
                    <div>
                        <label htmlFor="produto" className="block mb-2 text-sm font-medium text-transparent dark:text-white" style={{ textShadow: '0 0 4px black' }}>Pesquisar Produto</label>
            ...
            <div className="grid gap-6 mb-6 md:grid-cols-4 w-full">
                ...
                <div>
                    ...
                    <input {...register('peso')} type="text" className="bg-[#1a3a31] border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#1a3a31] dark:dark:bg-[#00593E] dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                </div>
