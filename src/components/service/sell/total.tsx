...
const Total = ({total}: TotalProps) => {
    return (
        <div className="w-full p-4 text-center bg-[#908782] border rounded-lg shadow sm:p-8 dark:w-full p-4 text-center bg-[#908782] border rounded-lg shadow sm:p-8 bg-[#B6B6B6] dark:bg-[#060F0E] dark:bg-opacity-85">
