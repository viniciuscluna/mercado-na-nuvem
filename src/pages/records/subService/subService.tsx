...
import { getAll, desabled } from "../../../services/subServicoService";
...
const SubService = () => {
  ...
  const { mutateAsync: mutateDisableAsync } = useMutation({
    ...
    onSuccess: () => {
      ...
      addNotification({
        message: "Sub Categoria apagada com sucesso!",
        type: "success",
      });
    }
  });
  ...
  return (
    <>
      <ConfirmModal
        ...
        message="Deseja realmente excluir a Sub Categoria?"
      />
      <div className="flex flex-col mt-8">
        <div className="flex flex-col  gap-5">
          ...
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                {data instanceof Array ? data?.map((subServico, index) => (
                  <tr
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex gap-1"><NavLink title="Editar" to={`edit/${subServico.id}`}>
                        ...
                        <button type="button" title="Excluir" onClick={() => setDisableSelect(subServico.id)}>
